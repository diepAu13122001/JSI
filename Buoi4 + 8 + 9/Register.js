...
class Register {
    ...
    handleSubmit = (e) => {
        //khi có sự kiện được đẩy lên, sẽ đẩy ra một sự kiện và trình duyệt sẽ bắt nó. 
        //Tuy nhiên để ngăn cản sự mặc định, mình bắt lại sự kiện đó và ngăn chặn nó.
        e.preventDefault()
        ...
        firebase
            ...
            .then((userCredential) => {
                ...
                firebase.auth().user.updateProfile({displayName: userName})
